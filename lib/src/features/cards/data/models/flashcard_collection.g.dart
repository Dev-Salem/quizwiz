...
part of 'flashcard_collection.dart';
...
FlashcardCollection _flashcardCollectionDeserialize(
  ...
  final object = FlashcardCollection(
    cards: reader.readObjectList<Flashcard>(
          offsets[0],
...
extension FlashcardCollectionByIndex on IsarCollection<FlashcardCollection> {
  Future<FlashcardCollection?> getByUuid(String uuid) {
    return getByIndex(r'uuid', [uuid]);
  }

  FlashcardCollection? getByUuidSync(String uuid) {
  ...
  Future<List<FlashcardCollection?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<FlashcardCollection?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(FlashcardCollection object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(FlashcardCollection object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<FlashcardCollection> objects) {
    return putAllByIndex(r'uuid', objects);
  }

  List<Id> putAllByUuidSync(List<FlashcardCollection> objects,
      {bool saveLinks = true}) {
...
extension FlashcardCollectionQueryObject on QueryBuilder<FlashcardCollection,
    FlashcardCollection, QFilterCondition> {
  QueryBuilder<FlashcardCollection, FlashcardCollection, QAfterFilterCondition>
      cardsElement(FilterQuery<Flashcard> q) {
    return QueryBuilder.apply(this, (query) {
...
extension FlashcardCollectionQueryProperty
  ...
  QueryBuilder<FlashcardCollection, String, QQueryOperations>
      descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FlashcardCollection, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'name');
    });
  }

  QueryBuilder<FlashcardCollection, String, QQueryOperations> uuidProperty() {
    return QueryBuilder.apply(this, (query) {
...
void _flashcardSerialize(
  ...
  writer.writeLong(offsets[1], object.dueTime);
  writer.writeDouble(offsets[2], object.factor);
  writer.writeDouble(offsets[3], object.interval);
...
Flashcard _flashcardDeserialize(
  ...
  final object = Flashcard(
    ...
    dueTime: reader.readLongOrNull(offsets[1]) ?? 0,
    factor: reader.readDoubleOrNull(offsets[2]) ?? 2.5,
    interval: reader.readDoubleOrNull(offsets[3]) ?? 1.0,
    question: reader.readStringOrNull(offsets[4]) ?? '',
    repetitions: reader.readLongOrNull(offsets[5]) ?? 0,
...
extension FlashcardQueryFilter
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> dueTimeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'dueTime',
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> dueTimeGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> dueTimeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> dueTimeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> factorEqualTo(
    double value, {
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> factorGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> factorLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> factorBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
